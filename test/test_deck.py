...
def test_special_card_computation_twenty_one():
    ...
    deck = Deck()
    hand = [Card("h", 3, "DEFAULT"), Card("d", 4, "DEFAULT"), Card("s", 4, "DEFAULT"), Card("h", 4, "DEFAULT"), Card("c", 4, "DEFAULT")]
    special_cards = deck.compute_cards(hand)
...
def test_special_card_computation_sixteen():
    ...
    deck = Deck()
    hand = [Card("h", 4, "DEFAULT"), Card("d", 3, "DEFAULT"), Card("s", 3, "DEFAULT"), Card("h", 3, "DEFAULT"), Card("c", 3, "DEFAULT")]
    special_cards = deck.compute_cards(hand)
...
def test_special_card_computation_decomposed_seven():
    ...
    deck = Deck()
    hand = [Card("s", 7, "DEFAULT"), Card("h", 7, "DEFAULT"), Card("d", 3, "DEFAULT"), Card("s", 4, "DEFAULT")]
    special_cards = deck.compute_cards(hand)
...
def test_special_card_full_suit():
    ...
    deck = Deck()
    hand = [Card("s", 7, "DEFAULT"), Card("s", 3, "DEFAULT"), Card("s", 8, "DEFAULT"), Card("s", 4, "DEFAULT"), Card("s", 4, "DEFAULT")]
    special_cards = deck.compute_cards(hand)
