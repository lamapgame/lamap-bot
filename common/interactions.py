...
async def LEARN (update: Update) -> None:
  if (update.effective_user and update.message and update.effective_chat):
    ...
    if update.message.chat.type == 'private':
        ...
        await update.effective_chat.send_message(rules_cta, ParseMode.MARKDOWN, True, reply_to_message_id=update.message.message_id)
        await update.effective_user.send_message(rules_text, ParseMode.MARKDOWN, True)